...
Blockly.Toolbox.prototype.init = function() {
  ...
  /**
   * Wrapper div containing both toolbox menu and flyout (position: fixed).
   * @type {Element}
   */
  this.toolboxWrapperDiv =
      goog.dom.createDom(goog.dom.TagName.DIV, 'blocklyToolboxFlyoutWrapper');
  svg.parentNode.insertBefore(this.toolboxWrapperDiv, svg);
  ...
  this.toolboxWrapperDiv.appendChild(this.HtmlDiv);
  ...
  Blockly.bindEventWithChecks_(this.HtmlDiv, 'mousedown', this,
      function(e) {
        ...
        if (Blockly.utils.isRightButton(e) || e.target == this.HtmlDiv ||
            e.target == this.toolboxWrapperDiv) {
          // Close flyout.
...
Blockly.Toolbox.prototype.dispose = function() {
  ...
  goog.dom.removeNode(this.toolboxWrapperDiv);
  this.toolboxWrapperDiv = null;
  this.HtmlDiv = null;
...
Blockly.Toolbox.prototype.createFlyout_ = function() {
  ...
  this.toolboxWrapperDiv.appendChild(this.flyout_.createDom('svg'));
...
Blockly.Toolbox.prototype.position = function() {
  ...
  var wrapper = this.toolboxWrapperDiv;
  if (!treeDiv || !wrapper) {
    // Not initialized yet.
    return;
  }
  ...
  if (this.horizontalLayout_) {
    wrapper.style.width = svgSize.width + 'px';
    ...
    } else {  // Left: 不设置 wrapper 的 height/width/left，由 .blocklyToolboxFlyoutWrapper 的 class 样式控制
...
Blockly.Toolbox.prototype.getClientRect = function() {
  ...
  var toolboxRect = wrapper.getBoundingClientRect();
