 ...
 * @type {number}
 */
Blockly.VerticalFlyout.prototype.DEFAULT_WIDTH = 270;
...
Blockly.VerticalFlyout.prototype.position = function() {
  ...
  if (this.parentToolbox_) {
    ...
    var flyoutXOffset = 40; // flyout horizontal offset when toolbox on left (was categoryWidth -> 60px)
    var x = this.toolboxPosition_ == Blockly.TOOLBOX_AT_RIGHT ?
        targetWorkspaceMetrics.viewWidth : flyoutXOffset;
    var y = 0;
  } else {
    var x = this.toolboxPosition_ == Blockly.TOOLBOX_AT_RIGHT ?
